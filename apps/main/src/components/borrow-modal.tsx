...
export default function BorrowModal({ open, onClose }: BorrowModalProps) {
  ...
  const reset = () => { setGid(""); setError(null); setLoading(false); };
    ...
    >
      ...
      >
        <div className="mb-4 flex items-center justify-between">
          <h2 className="text-base font-semibold text-zinc-800">빌려주세요</h2>
          <button
            onClick={handleClose}
        ...
        <div className="space-y-3">
          <div className="flex flex-col gap-1">
            <label htmlFor="borrow-gid" className="text-xs font-medium text-zinc-500">
              대상 ID
            </label>
            <input
              id="borrow-gid"
