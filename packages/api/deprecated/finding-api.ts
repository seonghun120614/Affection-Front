...
export const finding = {
    ...
    ): Promise<FindingResponse> => await api.post(`${FINDING_PATH}/find`, body),

    getFindings: async (
        params?: PageRequestParams,
    ): Promise<PageResponse<FindingResponse>> =>
    ...
    // 습득 신고 (Found)
    createFounding: async (
        body: CreateFoundingRequest,
    ): Promise<FoundingResponse> =>
        await api.post(`${FINDING_PATH}/found`, body),

    getFoundings: async (
        params?: PageRequestParams,
    ): Promise<PageResponse<FoundingResponse>> =>
    ...
    updateFounding: async (
        foundingId: number,
        body: UpdateFoundingRequest,
    ): Promise<FoundingResponse> =>
